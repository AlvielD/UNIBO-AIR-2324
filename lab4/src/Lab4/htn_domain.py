...
class State(pyhop.State):
    def __init__(self):
        ...
        self.doors = {}         # whether the door is open or closed
        self.holding = {}
...
def Open(state, door):
    if(state.pos['me'] != door or state.doors[door] == 'Open'):
        return False
    else:
        state.doors[door] = 'Open'
        return state

def Close(state, door):
    if(state.pos['me'] != door or state.doors[door] == 'Closed'):
        return False
    else:
        state.doors[door] = 'Closed'
        return state
